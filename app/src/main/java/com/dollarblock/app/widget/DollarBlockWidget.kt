package com.dollarblock.app.widget
...
class DollarBlockWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        // Set click intent to open main activity with morphing animation flag
        val intent = Intent(context, MainActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
            putExtra("from_widget", true) // Flag to trigger expand animation
        }
